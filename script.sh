...
# TODO: speed limit arg --speed=[SPEED] -s [SPEED]
# TODO: accept list instead of a single URL --list=FILE -l FILE
...
# TODO: not working with twitter's HLS, e.g. video embedded in https://twitter.com/i/status/1422486545701871616
